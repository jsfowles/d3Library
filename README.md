...
Start your app by running `npm start`, and start debugging in VS Code by pressing `F5` or by clicking the green debug icon. , and look at this [page to see it in action](https://prettier.github.io/prettier/).
